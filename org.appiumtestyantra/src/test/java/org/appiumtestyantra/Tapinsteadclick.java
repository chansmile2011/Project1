	...
	public DesiredCapabilities cap;
	 ...
	 public AndroidDriver aDriver;
		...
		cap.setCapability("appPackage", "io.appium.android.apis");
	 	...
	 	{
	 	WebElement viewdata = aDriver.findElementByAccessibilityId("Views");
	 
	 	aDriver.tap(1,viewdata,500);
	 	
	 	Thread.sleep(3000);
	 	
	 	WebElement ctrl = aDriver.findElementByAccessibilityId("Controls");
		aDriver.tap(1, 46, 554,500);
